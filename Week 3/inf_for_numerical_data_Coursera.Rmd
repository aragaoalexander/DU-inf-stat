...
<li> **[X] Both distributions are extremely right skewed.**</li>
<li> The IQRs of the distributions are roughly equal. </li>
</ol>
```{r habit-weight-box}
nc %>%
  ggplot()+
  geom_boxplot(mapping = aes(y = weight, colour = habit))
...
<li>**[X] $H_0: \mu_{smoking} = \mu_{non-smoking}$; $H_A: \mu_{smoking} \ne \mu_{non-smoking}$ ** </li>
...
**R: ** The null hypothesis is rejected on a 95% confidence level, which means that there is a significant difference between birth weights for smoker and non-smoker moms.
</div>
...
<li> **[X] We are 95% confident that the difference in average weights of babies whose moms are smokers and nonsmokers is between 0.05 to 0.58 pounds.** </li>
