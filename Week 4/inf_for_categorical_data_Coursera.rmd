...
<li> **[X]A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries.** </li>
</ol>
...
n_atheist_us = nrow(atheist_us)
n_atheist_us/nrow(us12)
...
**R:**
*Conditions:*
*1. Independence:* Random sample check, sample smaller than 10% of population.
*2. Sample Size:* More than 10 atheists and 10 non-atheists in sample check.
...
**R:** It's the probable range for the proportion.
</div>
...
<li> **[X]The margin of error for the estimate of the proportion of atheists in the US in 2012 is 0.0135.** </li>
</ol>
...
<li> **[X]The most conservative estimate when calculating a confidence interval occurs when $p$ is set to 1.** </li>
</ol>
...
```{r spain-05-12}
#Creating spain dataframe
spain <- atheism %>%
  filter(nationality == "Spain", year == "2005"|year == "2012")


inference(y = response, x = as.factor(year), data = spain, statistic = "proportion", type = "ht", alternative = "twosided", method = "theoretical", success = "atheist")
...
inference(y = response, x = as.factor(year), data = us, statistic = "proportion", type = "ht", alternative = "twosided", method = "theoretical", success = "atheist")
